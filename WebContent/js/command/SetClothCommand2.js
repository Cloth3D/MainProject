...
var SetClothCommand = function(human, type, cloth_id, cloth_url, cloth_mat, cloth_opacity)
/**
* 采用不同步的方式加载贴图和模型
* 参数说明:
* hu: 此类在全局中的名称
...
*/
{
  ...
  this.url_cloth = cloth_url;
  this.url_diffuse = cloth_mat.diffuse;
  this.url_specular = cloth_mat.specular;
  this.url_normal = cloth_mat.normal;
  this.url_Opacity = cloth_mat.opacity;
  this.url_light = cloth_mat.lighting;
  this.url_human_alpha = cloth_opacity;
  
  this.cloth_id = cloth_id;						// 用来处理分享,将id保存在,模型上
